    ...
    <div>
        ...
        <div id="googleMap" style="width:1100px; height:300px; margin-left:auto; margin-right:auto"></div>
            ...
            <h4>Patients Location</h4>
                <p>
                    <input id="inputpid" style="width:150px;height:18px;" />
                    <asp:Button ID="Button1" runat="server" Text="Tracking Patient" Width="110px" OnClientClick="return trackingThePatient(gv_location.id)"/>
                </p>
